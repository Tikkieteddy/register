...
> 📍 **สถานะปัจจุบัน: เฟส 5.5 เสร็จแล้ว — ระบบเดียวรองรับได้หลายงานพร้อมกัน**
> หน้าแรกรวมงาน · สร้างงานใหม่จากหลังบ้าน · สลับงานที่กำลังจัดการ
> เฟสถัดไปคือเฟส 6 — ความปลอดภัยและ PDPA
...
| [`docs/UAT-checklist.md`](docs/UAT-checklist.md) | **เช็กลิสต์ทดสอบก่อนใช้งานจริง** — รวมทุกข้อที่ต้องทดสอบจากทุกเฟสไว้ที่เดียว 191 ข้อ พร้อมช่องกรอกผล |
