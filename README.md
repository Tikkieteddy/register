...
> 📍 **สถานะปัจจุบัน: เฟส 4 เสร็จแล้ว — ระบบหน้างานพร้อมใช้ ทำงานได้แม้เน็ตหลุด**
> เฟสถัดไปคือเฟส 5 — ระบบหลังบ้าน Admin (Dashboard 11 กราฟ · Media Manager · Export)
...
| [`docs/UAT-checklist.md`](docs/UAT-checklist.md) | **เช็กลิสต์ทดสอบก่อนใช้งานจริง** — รวมทุกข้อที่ต้องทดสอบจากทุกเฟสไว้ที่เดียว 141 ข้อ พร้อมช่องกรอกผล |
