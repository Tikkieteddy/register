          ...
          >
            ...
            <div className="pb-1">
              <Toggle
                ...
                label="ปิดรับช่วงนี้"
                /*
                 * ช่องนี้ความหมายกลับด้านกับช่องอื่นในระบบ (ติ๊ก = ปิด ไม่ใช่ติ๊ก = เปิด)
                 * เพราะผูกกับค่า isClosed ในฐานข้อมูลโดยตรง จึงต้องเขียนกำกับให้ชัด
                 * ไม่งั้นผู้ดูแลอาจติ๊กเพราะคิดว่า "เปิดรับ" แล้วปิดรับลงทะเบียนโดยไม่ตั้งใจ
                 */
                hint="ติ๊กแล้วช่วงเวลานี้จะไม่รับลงทะเบียนเพิ่ม"
              />
            </div>
