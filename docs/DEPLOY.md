...
> **หมายเหตุ:** ตัว build เองไม่ต้องใช้ environment variables เลย — ยืนยันด้วยการ build
> ในเครื่องที่ไม่มีไฟล์ `.env` ใด ๆ แล้วผ่าน ถ้า build ล้มจึงเป็นปัญหาที่โค้ด ไม่ใช่ที่ค่าที่ตั้ง
> ส่วนค่าที่ตั้งไว้จะถูกใช้ตอนเว็บทำงานจริงเท่านั้น
